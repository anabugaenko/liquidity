...
def find_rescaling_exponents(fitting_method: str, xy_values: pd.DataFrame) -> Fit:
...
# Rename to compute_scale factors
def compute_RN_QN(features_df, alpha, beta, fitting_method="MLE"):
    ...
    RN_fit_object = find_rescaling_exponents(fitting_method, RN_df)
    QN_fit_object = find_rescaling_exponents(fitting_method, QN_df)
