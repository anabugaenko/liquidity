...
from liquidity.price_impact.lo_impact import get_aggregate_lo_response_features
...
def get_fit_params(data_all, y_reflect=False, f_scale=0.2):
...
def fit_scale_function(df, x_col='vol_imbalance', y_col='R', y_reflect=False):
