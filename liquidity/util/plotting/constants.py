...
TSLA_COLORS = ColorChoice(security_name='TSLA',
...
MSFT_COLORS = ColorChoice(security_name='MSFT',
                          dark_line_color="#0E1111",
...
AMZN_COLORS = ColorChoice(security_name='AMZN',
                          dark_line_color="#0E1111",
...
NFLX_COLORS = ColorChoice(security_name='NFLX',
                          dark_line_color="#0E1111",
...
EBAY_COLORS = ColorChoice(security_name='EBAY',
                          dark_line_color="#0E1111",
